...
def generarMenu(usuario):
    ...
    with st.sidebar:
        ...
        st.page_link("pages/pagina1.py", label="Normatividad", icon=":material/sell:")
        st.page_link("pages/pagina2.py", label="Estadísticas", icon=":material/shopping_cart:")
        st.page_link("pages/pagina3.py", label="Documentos", icon=":material/group:")    
